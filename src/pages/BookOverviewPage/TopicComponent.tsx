...
const TopicComponent: React.FC<TopicProps> = ({TopicName}) => {
    return (
        <div className="my-10 px-4 sm:px-8 max-w-5xl m-auto">
            <h1 className="text-center font-semibold text-lg">{TopicName}</h1>
            <ul className="border border-gray-200 rounded overflow-hidden shadow-md mt-5">
                ...
                </li>                <li className="px-4 py-2 bg-white hover:bg-sky-100 hover:text-sky-900 border-b last:border-none border-gray-200 transition-all duration-300 ease-in-out">
                    <a href="/Academy-Frontend/book/title:BookTitle">
                        Third Item
                    </a>
                </li>                <li className="px-4 py-2 bg-white hover:bg-sky-100 hover:text-sky-900 border-b last:border-none border-gray-200 transition-all duration-300 ease-in-out">
